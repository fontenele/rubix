    ...
    $.fn.extend({
        ...
        datetimepicker: function(o) {
            ...
            if (typeof(o) == 'string') {
                ...
                return this.each(function() {
                    var $t = $(this);
                    var defaults = $.timepicker._newInst($t, o)._defaults;

                    defaults.beforeShow = function(textbox, inst) {

                        inst.dpDiv.css({marginLeft: textbox.offsetWidth + 'px'});
                        setTimeout(function() {
                            inst.dpDiv.css('top', $(textbox).position().top);
                            inst.dpDiv.css('left', $(textbox).position().left + 2);
                        }, 0);

                    }

                    $t.datepicker(defaults);
                });
            }
        }
    });
